...
class NumStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Fact = channel.unary_unary(
                ...
                response_deserializer=numstore__pb2.SetFactResp.FromString,
                )
...
def add_NumStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Fact': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=numstore__pb2.SetFactResp.SerializeToString,
            ),
    }
...
class NumStore(object):
    ...
    def Fact(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/NumStore/Fact',
            ...
            numstore__pb2.SetFactResp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
